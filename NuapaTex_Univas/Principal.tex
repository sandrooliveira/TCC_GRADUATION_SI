...
\input{editaveis/10_a_Introducao}
%\input{editaveis/10_b_Justificativa.tex}
%\input{editaveis/10_c_Objetivos.tex}
...
\addcontentsline{toc}{chapter}{REFERÊNCIAS} % adiciona o título no
% sumário
